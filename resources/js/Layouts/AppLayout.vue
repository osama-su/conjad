                    ...
                    <ChevronDownIcon class="ml-2 h-5 w-5 text-gray-400" aria-hidden="true"/>
                            ...
                            <transition enter-active-class="transition ease-out duration-100"
                                ...
                                <MenuItems
                                    ...
                                    <MenuItem>
                                        <MenuButton as="button" @click="logout"
                                                    class="w-full text-left px-3 py-1 text-sm leading-6 text-gray-900">
                                            Sign out
                                        </MenuButton>
                                    </MenuItem>
                                </MenuItems>
...
const navigation = [
    ...
    {name: 'Cities', href: route('cities.index'), icon: DocumentDuplicateIcon, current: false},
]
